...
export const metadata: Metadata = {
  ...
  description: 'Mide distancias y áreas en planos, imágenes y PDFs directamente en tu navegador. Calibración de escala de referencia. Gratuito, sin registro, sin instalación.',
  alternates: {
